...
{
    public class PolarSector
    {
        public PolarSector(double radiusMin, double radiusMax, double angleDegMin, double angleDegMax)
        {
            if (radiusMin < 0.0)
    ...
    public class PolarSectorColored : PolarSector
    {
        ...
        public PolarSectorColored(double radiusMin, double radiusMax, double angleDegMin, double angleDegMax, Color color) : base(radiusMin, radiusMax, angleDegMin, angleDegMax)
        {
            Color = color;
        }
    }
